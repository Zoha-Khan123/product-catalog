...
const UpdateProduct = () => {
  ...
  return (
   <div className="min-h-[calc(100vh-56px)] pt-14  overflow-y-auto flex items-center justify-center bg-gradient-to-br from-indigo-900 via-purple-900 to-black p-4">
  <div className="w-full max-w-xl bg-white rounded-2xl shadow-lg p-8">
    ...
    <form onSubmit={handleUpdate} className="space-y-4">
      ...
      <button
        type="submit"
        className="w-full bg-purple-700 text-white font-semibold py-2 rounded-md hover:bg-purple-800 transition duration-300"
      >
        Update Product
      </button>
    </form>
