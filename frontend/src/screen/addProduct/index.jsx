...
const AddProduct = () => {
  ...
  return (
   <div className="min-h-[calc(100vh-56px)] pt-20 overflow-y-auto flex items-center justify-center bg-gradient-to-br from-indigo-900 via-purple-900 to-black p-4">
